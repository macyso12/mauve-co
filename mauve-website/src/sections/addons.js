export const ADDONS = [
  ...
  { id: 'vendor-communication', name: 'Vendor Communication',         price: '$55',  description: 'Reaching out to and coordinating with all vendors leading up to your event.' },
  ...
  { id: 'venue-walkthrough',    name: 'Venue Walkthrough',            price: '$65',  description: 'An in-person site visit to assess the space, flow, and setup logistics ahead of your event.' },
